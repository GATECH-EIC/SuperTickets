...
# checkpoint_kwparams = json.load(open('ckpt_seg.json'))
# checkpoint_kwparams = json.load(open('ckpt_cls.json'))
# checkpoint_kwparams = json.load(open('ckpt_seg_ade20k.json'))
